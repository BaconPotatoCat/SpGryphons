...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        ...
        holder.wordItemView.setText("Project Title: " + current.getWord() + "\nDate: " + current.getDate());
        final WordViewHolder h = holder;

        holder.delete_button.setOnClickListener(new MyButtonOnClickListener(current.getId()) {
                                                    @Override
        ...
        holder.edit_button.setOnClickListener(new MyButtonOnClickListener(current.getId(), current.getWord(), current.getDate()) {
            @Override
            public void onClick(View v) {
                ...
                ((Activity) mContext).startActivityForResult(intent, project.WORD_EDIT);
            }
        });
    }
